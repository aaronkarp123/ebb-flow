...
void draw() {
  ...
  /*
  camera(grav_x, grav_y, zoom, // eyeX, eyeY, eyeZ
         grav_x, grav_y, 0.0, // centerX, centerY, centerZ
  ...
  */
  ...
  /*fill(255-random(50), 0+random(50), 255-random(50), 63);
  noStroke();
  ellipse(grav_x, grav_y, 10, 10);*/
}
